...
double col_bvp(int s, int r, int block_size, double *u_h) {
  ...
  */
  ...
  /*
  DPCT1012:130: Detected kernel execution time measurement pattern and generated
  ...
  */
  ...
  /*
  DPCT1012:131: Detected kernel execution time measurement pattern and generated
  an initial code for time measurements in SYCL. You can change the way time is
  measured depending on your goals.
  */
  stop->wait();
