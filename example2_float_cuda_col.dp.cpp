...
double col_bvp(int s, int r, int block_size, float *u_h) {
  ...
  */
  ...
  /*
  DPCT1012:166: Detected kernel execution time measurement pattern and generated
  ...
  */
  ...
  /*
  DPCT1049:96: The work-group size passed to the SYCL kernel may exceed the
  limit. To get the device limit, query info::device::max_work_group_size.
  Adjust the work-group size if needed.
  */
  ...
  *stop = q_ct1.parallel_for(
  ...
  /*
  DPCT1012:167: Detected kernel execution time measurement pattern and generated
  an initial code for time measurements in SYCL. You can change the way time is
  measured depending on your goals.
  */
  stop->wait();
