...
double row_bvp(int s, int r, int block_size, double *u_h) {
  ...
  */
  ...
  stop = new sycl::event();
  /*
  DPCT1012:138: Detected kernel execution time measurement pattern and generated
  ...
  */
  ...
  /*
  DPCT1012:139: Detected kernel execution time measurement pattern and generated
  an initial code for time measurements in SYCL. You can change the way time is
  measured depending on your goals.
  */
  stop->wait();
